  ...
  return (
    <section className="py-16 px-4 sm:px-6 lg:px-8">
      <div className="container">
        <div className="relative rounded-[2rem] lg:rounded-[3rem] overflow-hidden bg-gradient-to-br from-primary via-primary to-primary/90 min-h-[320px] sm:min-h-[380px] lg:min-h-[480px]">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center text-center px-6 sm:px-8 lg:px-12 py-12 sm:py-16 lg:py-24 h-full min-h-[320px] sm:min-h-[380px] lg:min-h-[480px]">
            {/* Floating badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-foreground/20 backdrop-blur-sm border border-primary-foreground/30 mb-6 animate-bounce [animation-duration:3s]">
            ...
            <div className="relative mb-6">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-primary-foreground mb-2 leading-tight text-balance">
