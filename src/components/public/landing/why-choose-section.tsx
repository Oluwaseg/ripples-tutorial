      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            <div className="absolute -bottom-8 -left-8 w-32 h-32 bg-orange-500 rounded-full opacity-80 z-0"></div>
          ...
          <div className="space-y-8">
            ...
            <Button className="bg-orange-600 hover:bg-orange-700 text-white px-10 py-6 rounded-full text-lg font-medium">
              LEARN MORE
