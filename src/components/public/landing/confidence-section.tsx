          ...
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className='relative z-10'>
                <div className='text-3xl sm:text-4xl lg:text-5xl xl:text-5xl font-bold bg-gradient-to-br from-[color:var(--primary)] to-[color:var(--accent)] bg-clip-text text-transparent mb-3 sm:mb-4 group-hover:scale-110 transition-transform duration-300'>
                  {stat.value}
                </div>
