...
export default function AdmissionsPage() {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-primary via-primary/95 to-accent text-primary-foreground py-20 md:py-40 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[url('https://images.pexels.com/photos/8421995/pexels-photo-8421995.jpeg')] bg-cover bg-center opacity-75" />
          ...
          <div className="max-w-5xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div className="order-2 md:order-1">
                  <div className="relative h-64 md:h-80 rounded-2xl overflow-hidden bg-muted hover:shadow-2xl transition-all group-hover:scale-[1.02]">
                    <img
                      src="https://images.pexels.com/photos/5691835/pexels-photo-5691835.jpeg"
                      alt="Show Interest"
            ...
            <div className="relative mb-12 md:mb-16 group">
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div className="order-2 md:order-1">
                  <div
                    className="w-full h-[500px] bg-center bg-cover transition-transform  duration-500"
                    style={{
                      backgroundImage:
                        "url('https://images.pexels.com/photos/34114006/pexels-photo-34114006.jpeg')",
                    }}
                  ></div>
                </div>
                <div className="order-1 md:order-2">
            ...
            <div className="relative group">
              <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div>
                  <div className="relative h-64 md:h-80 rounded-2xl overflow-hidden bg-muted hover:shadow-2xl transition-all group-hover:scale-[1.02]">
                    <img
                      src="https://images.pexels.com/photos/7944236/pexels-photo-7944236.jpeg"
