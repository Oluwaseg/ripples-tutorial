...
export default function OneOnOneTuitionPage() {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative text-primary-foreground py-24 md:py-40 overflow-hidden">
        {/* <div className="absolute inset-0 bg-[url('https://images.pexels.com/photos/1164572/pexels-photo-1164572.jpeg')] bg-cover bg-center opacity-80" /> */}
        <div className="absolute inset-0 overflow-hidden">
          <video
            className="w-full h-full object-cover"
            src="/videos/one-on-one.mp4"
            autoPlay
            loop
            muted
            playsInline
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <Badge className="mb-6 bg-primary text-primary-foreground hover:bg-primary/90 transition-all hover:scale-105 px-6 py-2 text-sm font-medium shadow-lg">
                  <Star className="h-4 w-4 mr-2 inline" />
                  Premium Personalised Learning
                </Badge>
                <h1 className="text-5xl text-white md:text-6xl lg:text-7xl font-bold mb-8 text-balance leading-tight tracking-tight">
                  One-on-One
              ...
              <div className="relative">
                <div className="relative h-[500px] rounded-3xl overflow-hidden bg-muted shadow-2xl hover:shadow-3xl transition-all hover:scale-[1.02] group">
                  <img
                    src="https://images.pexels.com/photos/3769995/pexels-photo-3769995.jpeg"
                ...
                <div className="absolute -top-6 -right-6 bg-card border-2 border-border rounded-2xl px-4 py-3 shadow-2xl hover:scale-105 transition-all hover:shadow-3xl">
      ...
      <section className="py-16 md:py-24 bg-primary/10">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-12 md:mb-16">
            <Badge
              className="mb-4 text-white p-2.5 bg-primary hover:bg-primary/80 hover:scale-105 transition-transform"
              variant="outline"
            >
      ...
      <section className="py-16 md:py-24 bg-primary/10">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-12">
            <Badge
              className="mb-4 text-white p-2.5 bg-primary hover:scale-105 transition-transform"
              variant="outline"
            >
          ...
          <div className="max-w-6xl mx-auto space-y-8">
            {/* 11Plus Programme */}
            <Card className="overflow-hidden hover:shadow-2xl transition-all ] border-2 hover:border-primary group">
            ...
            {/* GCSE Programme */}
            <Card className="overflow-hidden hover:shadow-2xl transition-all border-2 hover:border-secondary group">
              <div className="grid lg:grid-cols-2 gap-0">
            ...
            {/* A-Level Programme */}
            <Card className="overflow-hidden hover:shadow-2xl transition-all border-2 hover:border-accent group">
              <div className="grid lg:grid-cols-2 gap-0">
                <div className="relative h-64 lg:h-auto">
                  <img
      ...
      <section className="py-16 md:py-24 bg-accent/30">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-12">
            <Badge className="mb-4 text-sm text-white bg-primary p-1.5 hover:scale-105 transition-transform">
              Simple Process
            </Badge>
