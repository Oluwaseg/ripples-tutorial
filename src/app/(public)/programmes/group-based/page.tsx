...
export default function GroupBasedTuitionPage() {
  return (
    <div className='min-h-screen'>
            ...
            <div className='grid lg:grid-cols-2 gap-12 items-center'>
              <div>
                ...
                <h1 className='text-5xl md:text-7xl lg:text-8xl font-bold mb-8 text-balance leading-tight tracking-tight'>
                  Group-Based
                  <span className='block text-secondary mt-2'>Tuition</span>
                </h1>
              ...
              <div className='relative'>
                ...
                <div className='absolute -bottom-6 -left-6 bg-card border-2 border-border rounded-2xl p-6 shadow-2xl max-w-xs hover:scale-105 transition-all hover:shadow-3xl'>
                  <div className='flex items-center gap-3 mb-2'>
                    ...
                    <div>
                      <div className='text-2xl font-bold'>Grades 8-9</div>
      ...
      <section className='py-16 md:py-24 bg-muted/30'>
        <div className='container mx-auto px-4 md:px-6'>
          ...
          <div className='max-w-3xl mx-auto text-center'>
            <div className='bg-secondary/10 border-2 border-secondary/30 rounded-2xl p-8 hover:bg-secondary/20 transition-all hover:shadow-2xl hover:scale-[1.02]'>
            ...
            <div className='grid md:grid-cols-3 gap-6'>
              {[
                ...
                >
                  <CardHeader>
                    <Badge
                      className='mx-auto mb-3 hover:scale-105 transition-transform'
                      variant='secondary'
                    >
                      {cat.ages}
                    </Badge>
      ...
      {/* CTA Section */}
      <section className='py-16 md:py-24 bg-gradient-to-br from-secondary via-primary to-accent text-primary-foreground relative overflow-hidden'>
        <div className='absolute inset-0 overflow-hidden'>
