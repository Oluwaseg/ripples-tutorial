  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative  text-primary-foreground py-24 md:py-40 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[url('https://images.pexels.com/photos/249360/pexels-photo-249360.jpeg')] bg-cover bg-center " />
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-5xl md:text-7xl lg:text-6xl font-bold mb-8 text-balance leading-tight tracking-tight">
                  Self-Tuition with
              ...
              <div className="relative">
                <div className="relative h-[500px] rounded-3xl overflow-hidden bg-muted shadow-2xl hover:shadow-3xl transition-all hover:scale-[1.02] group">
                  <img
                    src="https://images.pexels.com/photos/3808060/pexels-photo-3808060.jpeg"
                ...
                {/* Floating stat cards */}
                <div className="absolute -bottom-6 -left-6 bg-card border-2 border-border rounded-2xl px-4 py-3 shadow-2xl max-w-xs hover:scale-105 transition-all hover:shadow-3xl">
                ...
                <div className="absolute -top-6 -right-6 bg-card border-2 border-border rounded-2xl p-3 shadow-2xl hover:scale-105 transition-all hover:shadow-3xl">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
              ...
              <div className="relative">
                <div className="relative h-[500px] rounded-3xl overflow-hidden bg-muted shadow-2xl hover:shadow-3xl transition-all hover:scale-[1.02] group">
                  <img
                    src="https://images.pexels.com/photos/4560076/pexels-photo-4560076.jpeg"
                    alt="Learning Platform"
                    className="w-full h-full object-cover transition-transform group-hover:scale-110 duration-500"
                  />
                </div>
